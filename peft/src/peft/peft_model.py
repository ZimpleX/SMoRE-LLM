...
from .tuners import HieRMoEModel
...
PEFT_TYPE_TO_MODEL_MAPPING = {
    PeftType.HIER_MOE: HieRMoEModel,
}
    ...
    **Attributes**:
    ...
    def __init__(
        ...
        if self._is_prompt_learning:
            ...
            cls = PEFT_TYPE_TO_MODEL_MAPPING[peft_config.peft_type]  # e.g., LoraModel
