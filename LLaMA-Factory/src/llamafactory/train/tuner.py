...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = [], hparam_exp_name: Optional[str]=None) -> None:
    callbacks.append(LogCallback())
    model_args, data_args, training_args, finetuning_args, generating_args = get_train_args(args)

    assert finetuning_args.stage == "sft"
    run_sft(model_args, data_args, training_args, finetuning_args, generating_args, callbacks, hparam_exp_name=hparam_exp_name)
