...
@dataclass
class Llama2TemplateNew(TemplateNew):
...
def get_template_and_fix_tokenizer(tokenizer: "PreTrainedTokenizer", data_args: "DataArguments") -> "Template":
    ...
    """
    if not isinstance(TEMPLATES[data_args.template], TemplateNew):
        ...
        if getattr(data_args, "default_system", None) is not None:
        ...
        if hasattr(data_args, "enable_thinking"):
...
#     efficient_eos=True,
#     template_class=Llama2TemplateNew,
# )
...
_register_template(
    name="llama2_plain",
    format_user=StringFormatter(slots=[{"bos_token"}, "{{content}}", {"eos_token"}]),
    format_system=StringFormatter(slots=["<<SYS>>\n{{content}}\n<</SYS>>\n\n"]),
)
